...
public class EmployeeController extends HttpServlet {
    ...
    private void addEmployee(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            e.printStackTrace();  // Log erreur si la conversion de la date échoue
            request.setAttribute("errorMessage", "Erreur lors de la conversion de la date.");
            request.getRequestDispatcher("errorPage.jsp").forward(request, response);
        } catch (NumberFormatException e) {
            e.printStackTrace();  // Log erreur si la conversion du salaire échoue
            request.setAttribute("errorMessage", "Erreur lors de la conversion du salaire.");
            request.getRequestDispatcher("errorPage.jsp").forward(request, response);
        } catch (Exception e) {
            e.printStackTrace();  // Log erreurs générales
